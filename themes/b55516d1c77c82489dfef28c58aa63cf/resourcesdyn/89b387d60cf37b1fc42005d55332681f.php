...
<html>
  ...
  <body>
    ...
    <form id="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
      ...
      <input type="hidden" name="return" value="<?php echo "http://".$_SERVER['SERVER_NAME'].$objUtility->getPathRoot().getCurLanClass()."/".$id."/grazie.html"; ?>">
      <input type="hidden" name="rm" value="2">
      <input type="hidden" name="notify_url" value="<?php echo "http://".$_SERVER['SERVER_NAME'].$objUtility->getPathRoot()."rsAction.php"; ?>">
      <input type="hidden" name="cancel_return" value="<?php echo "http://".$_SERVER['SERVER_NAME'].$objUtility->getPathRoot().getCurLanClass()."/".$id."/pagamento-fallito.html"; ?>">
