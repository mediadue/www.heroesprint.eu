  ...
  */
  ...
  function makeEmbedded($html) {
    ...
    foreach ($imgs as $img){
      ...
      //echo SERVER_DOCROOT;exit;
      
      $mail->AddEmbeddedImage($file, $name, $name);
  ...
  function mmail($destinatario,$mittente,$oggetto,$messaggio,$allegato,$allegato_type,$allegato_name) {
    ...
    $mail->Host     = "smtp.heroesprint.eu"; // SMTP servers
    $mail->SMTPAuth = true;     // turn on SMTP authentication
    $mail->Username = "info@heroesprint.eu";  // SMTP username
    $mail->Password = "!MediaHRS.01!"; // SMTP password
