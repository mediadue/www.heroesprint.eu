...
<body style="background:#fff;">
    ...
    <div id="sliderb_container" style="position: relative; width: 393px;
        height: 232px; overflow: hidden;border:1px red solid;">
        ...
        <div u="thumbnavigator" class="sliderb-T" style="position: absolute; bottom: 0px; left: 0px; height:45px; width:393px;">
