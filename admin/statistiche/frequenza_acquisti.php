...
<div id="site">
	...
	<div id="content">
		...
		<div id="area">
			<?php $objHtml->adminPageTitle("statistiche", "Frequenza d'acquisto") ?>
			<div id="body">
				<div class="container">
				  <div class="inputdata"> 
                ...
                <div class="label"><? echo $label; ?><label for="<? echo $label; ?>"> </label></div>
                  ...
                  <select multiple name='users[]'>
                    ...
                    while (list($key, $row) = each($rs)) {
                      ...
                      ?><option value='<?=$row['id']?>' ><?=$row['ragionesociale']?><?
                      } 
                    }
                    ?>
                  </select>
                  ...
                  &nbsp;&nbsp;<input type="submit" name="act_GEN-GRAPH-FREQ-ACQ" value="crea grafico" class="btn" />
                </div>
               </div>
            </form>
    			</div>
