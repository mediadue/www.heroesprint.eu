...
<div id="site">
	...
	<div id="content">
		...
		<div id="area">
			<?php $objHtml->adminPageTitle("statistiche", "Importo medio scontrino") ?>
			<div id="body">
				<div class="container">
				  <div class="inputdata"> 
            <form action="action.php" id="frm" name="frm" method="post" enctype="multipart/form-data" />
              <div class="elemento">
                ...
                <div class="label"><? echo $label; ?><label for="<? echo $label; ?>"> </label></div>
        				<div class="value">
                  <span style="padding-right:5px;font-weight:bold;">dal</span> <? formdata($key,'','','','',''); ?>
                  <span style="padding-right:5px;font-weight:bold;padding-left:5px;">al</span> <? formdata($key."_a",'','','','',''); ?>
                  &nbsp;&nbsp;<input type="submit" name="act_GEN-GRAPH-IMP-MED-SCONTRINO" value="crea grafico" class="btn" />
                </div>
               </div>
            </form>
    			</div>
