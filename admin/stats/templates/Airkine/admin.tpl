...
<tr>
 <td width="150" valign="top" bgcolor="#ffffff" nowrap><br>
  ...
  <br>
   ...
   <TR>
   <td height='10' bgColor='#C1C1C1' colSpan='2' align="center><a href="http://robertobizzarri.altervista.org/php-stats/"><span class='copyright'><b>v{$option[phpstats_ver]}</b> &#169; Roberto Bizzarri (v0.1.9.2 &#169; Webmaster76) - $server_time</span></a>
 </td>  </TR>
</table>
</body>
</html>