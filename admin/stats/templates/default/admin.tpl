...
<table width="800" height="100%" bgcolor="black" cellspacing="1" cellpadding="1" align="center" class="pageborder">
  <tr>
   <td height="30" colspan="2" bgcolor="#C1C1C1">
      <table width="740">
            <tr>
                  <td><a href="http://robertobizzarri.altervista.org/php-stats/"><img src="templates/default/images/logo.gif" alt=""></a></td>
...
<tr>
 <td width="150" valign="top" bgcolor="#8C83B4">
        ...
        <!--Begin links-->
        <p class="menu"><img src="templates/default/images/bullet.gif"><a href="admin.php?action=links">$admin_menu[links]</a></p>
        <!--End links-->
  ...
  <br>
   ...
   <TR>
   <td height='10' bgColor='#C1C1C1' colSpan='2'><a href="http://robertobizzarri.altervista.org/php-stats/"><CENTER><span class='copyright'><b>v{$option[phpstats_ver]}</b> &#169; Roberto Bizzarri (v0.1.9.2 &#169; Webmaster76) - $server_time</span></CENTER></a>
   </TR>
</table>
</body>
</html>