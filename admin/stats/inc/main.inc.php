...
/*** NASCOSTE QUESTE 2 RIGHE
"\n\t<TR><TD align=right bgcolor=$style[table_bgcolor]><span class=\"tabletextA\">$string[main_tot_hits_nospider]</span></TD><TD bgcolor=$style[table_bgcolor]><span class=\"tabletextB\">".($hits_totali_glob-$total_spider_hits)."</span></TD>".
"\n\t<TR><TD align=right bgcolor=$style[table_bgcolor]><span class=\"tabletextA\">$string[main_tot_visits_nospider]</span></TD><TD bgcolor=$style[table_bgcolor]><span class=\"tabletextB\">".($visite_totali_glob-$total_spider_visits)."</span></TD>";
***/
endif;
