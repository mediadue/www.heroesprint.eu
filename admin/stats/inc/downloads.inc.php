...
"document.codice.downcode.value=\"<a href='#' onClick=\\\"Download=window.open('$option[script_url]/download.php?id=\"+id+\"','Download','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=auto,resizable=yes,width=400,height=200')\\\">Download</a>\";\n".
"}\n".
"</SCRIPT>\n";
...
if(mysql_num_rows($result)>0)
  ...
  while($row=mysql_fetch_row($result))
    ...
    "<td bgcolor=$style[table_bgcolor]><span class=\"tabletextA\"><center><a href=\"javascript:link('$id');\" onClick=\"link('$id')\">$id</a></center></span></td><td bgcolor=$style[table_bgcolor]><span class=\"tabletextA\">&nbsp;<b>$downloads_log_accessi</b></span></td><td bgcolor=$style[table_bgcolor]><center>".($option['check_links'] ? checkfile($downloads_log_url) : "<img src=\"templates/$option[template]/images/icon_bullet_orange.gif\" title=\"$string[down_notverify]\" alt=\"$string[down_notverify]\">")."</center></td></tr>";
    }
//  $return.="<tr><td height=\"1\" bgcolor=$style[table_title_bgcolor] colspan=\"6\" nowrap></td></tr>";
  ...
  "<tr><td bgcolor=$style[table_bgcolor]><center><textarea name=\"downcode\" cols=\"80\" rows=\"4\">$string[down_downcli]</textarea></center></form></td></tr>".
  "</table>";
  }
