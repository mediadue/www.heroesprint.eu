...
"?>";
  ...
  if(!is_writable("config.php"))
    ...
    {
    $configArray=Array('callviaimg','persistent_conn','autorefresh','show_server_details','show_average_user','short_url','ext_whois','online_timeout','page_title','refresh_page_title','log_host','clear_cache','full_recn','logerrors','check_new_version','bcap_auto_update','www_trunc','ip-zone','down_mode','check_links','ip_spam_filter','link_logger'); // Elenco option in config
