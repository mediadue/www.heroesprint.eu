...
'<tr>'.
"<td bgcolor=$style[table_title_bgcolor] nowrap><span class=\"tabletitle\"><center>$string[monthly_nome]</center></span></td>".
"<td bgcolor=$style[table_title_bgcolor] nowrap><span class=\"tabletitle\"><center>$string[monthly_hits]</center></span></td>".
...
for($i=0;$i<12;++$i)
  ...
  if($lista_visite[$i+1]>0)
    ...
    else $variazione=round(($lista_visite[$i]-$lista_visite[$i+1])/$lista_visite[$i+1]*100,1);
