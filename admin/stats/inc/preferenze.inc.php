...
//              $next=mktime(0,0,0,$date_m,$date_d-$date_w+$option_new_2['report_w_day']+7,$date_Y);
        ...
        "\n</table>\n</form>";
/*
        // TIPO DI MODALITA' IN CORSO
        "\n<br>\n<form action=\"admin.php?action=preferenze\" method=\"post\">".
        "<table border=\"0\" $style[table_header] width=\"90%\" align=\"center\" >".
        "<tr><td bgcolor=$style[table_title_bgcolor]><span class=\"tabletitle\">$pref[mode_type]</span></td></tr>".
        "<tr><td bgcolor=$style[table_bgcolor]><center><span class=\"tabletextA\">".($NowritableServer==0 ? $pref['writeMode'] : $pref['no_writeMode'])."</span><br><br><input name=\"change_mode\" type=\"hidden\" value=\"1\"><input type=\"Submit\" value=\"$pref[change_mode]\"></center><br></td></tr>".
        "</form></table>";
*/
        ////////////////////////////////
        ...
        "<textarea name=\"mainscript\" cols=\"80%\" rows=\"4\">".
...
/*
        ...
        /////////////////////////
        $return.=
        "\n<br>\n<form action=\"inc/down_staticjs.inc.php\" method=\"post\">".
        "<table border=\"0\" $style[table_header] width=\"90%\" align=\"center\" >".
        "<tr><td bgcolor=$style[table_title_bgcolor]><span class=\"tabletitle\">$pref[download_staticjs]</span></td></tr>".
        "<tr><td bgcolor=$style[table_bgcolor]><center><br><input type=\"Submit\" value=\"$pref[download_staticjs_go]\"></center><br></td></tr>".
        "</form></table>";
*/
        ///////////////////
        // GENERA CODICE //
        ...
        for($i=0;$i<6;++$i)$return.="<option value=\"$i\"".($whatview==$i ? ' selected' : '').">".$pref["cs_view_$i"]."</option>";
        $return.=
        "</select></td></tr>".
        ...
        "</td></tr>".
        "</table>".
        "<center><textarea name=\"scriptcode\" cols=\"80%\" rows=\"3\">";
