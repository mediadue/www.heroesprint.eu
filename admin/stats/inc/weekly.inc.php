...
if(isset($_POST['sel_anno'])) $sel_anno=addslashes($_POST['sel_anno']);
     ...
     if(isset($_GET['sel_anno'])) $sel_anno=addslashes($_GET['sel_anno']); $sel_anno=$anno;
     }
...
***/
     if(isset($_GET['mode'])) $mode=addslashes($_GET['mode']); else $mode=1;
...
if($mode==0) $phpstats_title=str_replace(Array('%MESE%','%ANNO%'),Array(formatmount($sel_mese),$sel_anno),$string['weekly_title_2']);
else $phpstats_title=$string['weekly_title'];
//
$accessi=Array(0,0,0,0,0,0,0);
...
//
$return.=
"<table border=\"0\" width=\"90%\" $style[table_header] align=\"center\" class=\"tableborder\">".
...
for($i=0;$i<7;++$i)
  ...
  "<td bgcolor=$style[table_bgcolor] align=\"right\" width=\"150\"><span class=\"tabletextA\">$oggi</span></td>".
  "<td bgcolor=$style[table_bgcolor] align=\"right\"><span class=\"tabletextA\"><b>$hits[$i]</b></span><br><span class=\"tabletextA\"><b>$accessi[$i]</b></span></td>".
...
if($mode==0)
  ...
  "<form action='./admin.php?action=weekly".($modulo[11] ? "&mode_2=$mode_2" : '')."' method='POST' name=form1><span class=\"tabletextA\">$string[calendar_view]</span>".
  ...
  '</FORM>'.
  '</td></tr>'.
  "<tr><td><span class=\"testo\"><a href=\"admin.php?action=weekly&mode=1\"><img src=templates/$option[template]/images/icon_change.gif border=\"0\" align=\"absmiddle\" hspace=\"1\" vspace=\"1\"> $string[weekly_vis_glob]</a></span></td></tr>";
  }
else $return.="<tr><td><span class=\"testo\"><a href=\"admin.php?action=weekly&mode=0\"><img src=templates/$option[template]/images/icon_change.gif border=\"0\" align=\"absmiddle\" hspace=\"1\" vspace=\"1\"> $string[weekly_vis_mens]</a></span></td></tr>";
$return.='</table></center>';
if($modulo[11]){
        // SELEZIONE MODALITA'
