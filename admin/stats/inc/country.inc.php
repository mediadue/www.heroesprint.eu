...
//(array)$data_areas:
//mode visits:
//query: area,sum of visits
//array format:
//Array(
//	Array((string)area,(number)sumvisits),
//	...
//);
//mode hits:
//query: area,sum of hits
//array format:
//Array(
//	Array([string]area,[number]sumvisits),
//	...
...
//(array)$data_countries:
//mode visits:
//query: tld,sum of visits ordered by sum of visits descending
//array format:
//Array(
//        Array((string)tld,(int)sumvisits),
//        ...
//);
//mode hits:
//query: tld,sum of hits ordered by sum of hits descending
//array format:
//Array(
//        Array((string)tld,(int)sumhits),
//        ...
//);
...
//(array)$output_areas:
//Array(
//        area=>Array((string)areaname,(int)sumwhat,(float)percent),
//        ...
//);

//(array)$output_countries:
//Array(
//        Array((string)countryname,(int)sumwhat,(float)percent,(int)barlength),
//        ...
//);
