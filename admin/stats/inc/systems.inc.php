...
if($modulo[1]==2){
        ...
        if($mode===0){
                ...
                "<br><br><a href=\"admin.php?action=systems&mode=1{$filterParams}\"><img src=templates/$option[template]/images/icon_change.gif border=\"0\" align=\"absmiddle\" hspace=\"1\" vspace=\"1\"><span class='testo'> $string[os_vis_glob]</span></a>".
                '</FORM>';
        }
        else $return.="<a href=\"admin.php?action=systems&mode=0{$filterParams}\"><img src=templates/$option[template]/images/icon_change.gif border=\"0\" align=\"absmiddle\" hspace=\"1\" vspace=\"1\"><span class='testo'> $string[os_vis_mens]</span></a>";
        $return.='</center>';
}
if($modulo[11]){
        $return.=
