...
switch($mode){
        case 0:	$what='data,hits,visits'; break;
        case 1: $what='data,(hits-no_count_hits) AS hits,(visits-no_count_visits) AS visits'; break;
        case 2: $what='data,no_count_hits AS hits,no_count_visits AS visits'; break;
}
...
for($i=29;$i>=0;--$i){
        ...
        $output_days[]=Array($dayLabel,$monthDay,$monthBreak,$isSunday,$hits,$visits,$visitsVariation,$hitsVBarLength,$hitsHBarLength,$visitsVBarLength,$visitsHBarLength,$level);
}
...
$return.=
"<table bgcolor=$style[table_bgcolor] border=\"0\" cellpadding=\"1\" cellspacing=\"1\" align=\"center\" class=\"tableborder\">".
"<tr><td valign=\"top\"><table bgcolor=$style[table_bgcolor] border=\"0\" cellpadding=\"0\" cellspacing=\"0\" align=\"center\">".
"<tr><td height=\"30\"><span class=\"testo\">$Hstep6</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Hstep5</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Hstep4</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Hstep3</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Hstep2</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Hstep1</span></td></tr>".
'</table></td>';
for($i=0,$tot=count($output_days);$i<$tot;++$i){
        ...
        $return.="<td height=\"200\" width=\"15\" valign=\"bottom\" align=\"center\" background=\"templates/$option[template]/images/table_grid.gif\"><img src=\"templates/$option[template]/images/style_bar_3.gif\" width=\"5\" height=\"$hitsVBarLength\"  title=\"$hits\"></td>";
}
...
"<tr><td bgcolor=$style[table_bgcolor] colspan=\"32\" nowrap><span class=\"tabletextA\"><center><img src=\"templates/$option[template]/images/style_bar_1.gif\" width=\"7\" height=\"7\"> $string[hits]</center></td></tr>".
//"<tr><td height=\"1\" bgcolor=$style[table_title_bgcolor] colspan=\"32\" nowrap></td></tr>".
'</table><br>'.
"<table bgcolor=$style[table_bgcolor] border=\"0\" cellpadding=\"1\" cellspacing=\"1\" align=\"center\" class=\"tableborder\">".
"<tr><td valign=\"top\"><table bgcolor=$style[table_bgcolor] border=\"0\" cellpadding=\"0\" cellspacing=\"0\" align=\"center\">".
"<tr><td height=\"30\"><span class=\"testo\">$Vstep6</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Vstep5</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Vstep4</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Vstep3</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Vstep2</span></td></tr>".
"<tr><td height=\"30\"><span class=\"testo\">$Vstep1</span></td></tr>".
'</table></td>';
for($i=0,$tot=count($output_days);$i<$tot;++$i){
        list($dayLabel,$monthDay,$monthBreak,$isSunday,$hits,$visits,$visitsVariation,$hitsVBarLength,$hitsHBarLength,$visitsVBarLength,$visitsHBarLength,$level)=$output_days[$i];

        $return.="<td height=\"200\" width=\"15\" valign=\"bottom\" align=\"center\" background=\"templates/$option[template]/images/table_grid.gif\"><img src=\"templates/$option[template]/images/style_bar_4.gif\"\" width=\"5\" height=\"$visitsVBarLength\" title=\"$visits\"></td>";
}
...
'</tr>'.
"<tr><td height=\"1\" bgcolor=$style[table_title_bgcolor] colspan=\"32\" nowrap></td></tr>".
"<tr><td bgcolor=$style[table_bgcolor] colspan=\"32\" nowrap><span class=\"tabletextA\"><center><img src=\"templates/$option[template]/images/style_bar_2.gif\" width=\"7\" height=\"7\"> $string[visite]</span></center></td></tr>".
//"<tr><td height=\"1\" bgcolor=$style[table_title_bgcolor] colspan=\"32\" nowrap></td></tr>".
'</table>';
...
///////////////////////////////
$return.=
"<br><br><table border=\"0\" width=\"90%\" $style[table_header] class=\"tableborder\">".
'<tr>'.
...
for($i=0,$tot=count($output_days);$i<$tot;++$i){
        ...
        if($monthBreak) $return.="<tr><td  bgcolor=$style[table_bgcolor] height=\"1\" colspan=\"5\"></td></tr>";

        $return.=
        "<tr onmouseover=\"setPointer(this, '$style[table_hitlight]', '$style[table_bgcolor]')\" onmouseout=\"setPointer(this, '$style[table_bgcolor]', '$style[table_bgcolor]')\"><td bgcolor=$style[table_bgcolor] align=\"right\">".
        "<span class=\"".($isSunday ? 'tabletextB' : 'tabletextA')."\">$dayLabel</span></td>".
