...
for (var ls = document.links, numLinks = ls.length, i=0; i<numLinks; i++)
	{ ls[i].href = \"/stats/link_logger.php?url=\"+escape(ls[i].href); }
}
...
if($option['callviaimg'])
	...
	$return.="\nvar sc1=\"<scr\"+\"ipt language='javascript' src='$option[script_url]/php-stats.php?w=\"+w+\"&amp;h=\"+h+\"&amp;c=\"+c+\"&amp;f=\"+f+\"&amp;NS_url=\"+NS_url+\"&amp;t=\"+t+\"&amp;ps_rettime=\"+rettime+\"&amp;ps_returns=\"+returns+\"&amp;ps_newret=\"+newret+\"'></scr\"+\"ipt>\";";
$return.="\ndocument.write(sc1);";
