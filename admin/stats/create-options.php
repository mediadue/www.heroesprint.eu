...
//sql_query("DROP TABLE /*!32300 IF EXISTS*/ $option[prefix]_options",FALSE);
//}
//else{
//sql_query("DROP TABLE /*!32300 IF EXISTS*/ $option[prefix]_options",FALSE);
//sql_query("CREATE TABLE $option[prefix]_options ( option_name varchar(20) NOT NULL default '', option_value longtext NOT NULL, PRIMARY KEY (option_name)) TYPE=MyISAM");
//sql_query("INSERT INTO $option[prefix]_options VALUES ('php-stats-options',''),('instat_max_online',''),('instat_report_w','')");

//$options_text=str_replace(Array('<?php','?>'),'',$options_text);
//$options_text=mysql_escape_string($options_text);
...
//sql_query("UPDATE $option[prefix]_options SET option_value='$options_text' WHERE option_name='php-stats-options'");
//sql_query("UPDATE $option[prefix]_options SET option_value='$option2[instat_report_w]' WHERE option_name='instat_report_w'");
//sql_query("UPDATE $option[prefix]_options SET option_value='$option2[instat_max_online]' WHERE option_name='instat_max_online'");
//$ok=TRUE;
//}
/*
$createFile=TRUE;
