...
<div id="site">
	...
	<div id="content">
		...
		<div id="area">
			<?php $objHtml->adminPageTitle("gestione sito web", "modifiche contestuali") ?>
			<div id="body">
				<div class="container">
					<?php $tblDefault->_print($filter="id='".$_GET['id']."'",$tblparent="",$parent="",$subPrint="-1",$colfilter=$_GET['field'],$onlyMod="1"); ?>
				</div>
			</div>
		</div>
	</div>
