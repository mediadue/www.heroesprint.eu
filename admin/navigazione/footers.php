...
$tblProfessionalita = new rsTable("footers");
...
$cf="";
if(!$isSystem) $cf="id,footer_editor";
	...
	<div id="content">
		...
		<div id="area">
			...
			<div id="body">
				<div class="container">
					<?php 
          $tblProfessionalita->_print($filter=$wh,$tblparent="",$parent="",$subPrint="",$colfilter=$cf,$onlyMod=$om); 
          ?>
				</div>
			</div>
		</div>
