...
class Carrello {
  ...
  function riepilogoCarrello() {
      ...
      <thead>
        ...
        <form action="" method="post" id="ecomm_form_viewcart" name="ecomm_viewcart"> 		  	 		
          ...
          while (list($key, $prodotto) = each($_SESSION['ecomm'])) { 
            ...
            if($magazzino!=false) {
              ...
              */
              $foto_prodotto=retFile($magazzino['immagine_file'],35);
              if(!$foto_prodotto) {
              ...
              if($_SESSION["userris_id"]>0) $sconto=$ecommerce_generali[0]['sconto_reg']; 
              ...
              while (list($key2, $variante) = each($prodotto)) { 
                if($key2!=="ecomm_buffer") {
                  ...
                  $tot=$tot+(($prezzo+$aggiunte)*$quantita*$area)+$aggiunteF+($aggiunteQ*$quantita);
                  ...
                  <tr class="body">
                    ...
                    <?php if($cols_carrello['totale']==1) { ?><td class="colonna_prezzi tot-articolo  text-right" data-th="<?php echo ln("totale"); ?>"><span><?php echo currencyITA($prezzo_finale+$aggiunteF+($aggiunte*$quantita*$area)+($aggiunteQ*$quantita)); ?></span></td><? } ?>			
                  </tr>
                <? } ?>
              <? } ?>
            <? } ?>
        ...
        <tr class="<?php if(($totali['sconto'])==0) { echo 'riga_prezzi_totale';} ?>">
          ...
          <td colspan='1' class="colonna_prezzi totale text-right" data-th="<?php echo ln("Totale");?>"> 
            <span <?php if(($totali['sconto'])>0) { ?>style="text-decoration:line-through;"<? } ?>><?echo currencyITA($totali['totale_senza_sconto']); ?></span>
          </td>
        </tr> 		 
        ...
        <tr class="noborders">
          <td colspan='<?php echo ($cols_count);?>' style="border-top: none;">
              <!-- Module 3A -->
              <div class="ez-wr calcolo-spese-spedizione clearfix">
                ...
                <div class="ez-fl ez-negmr ez-33 spese-spedizione-left form-block-inline">
                  <!-- Module 2A -->
                  <div class="ez-wr">
                    <div class="ez-fl ez-negmr ez-50 spedizione-nazione-label form-inline-el">
                      <div class="ez-box"><?php echo ln("nazione");?></div>
                    </div>
                    <div class="ez-last ez-oh spedizione-nazione form-inline-el">
                      <?php if($_SESSION['ecomm']['sp_nazione']=="") $_SESSION['ecomm']['sp_nazione']=106; ?>
                      <div class="ez-box"><?php comboBox("nazioni",$field1="naz_eng",$field2="",$selected=$_SESSION['ecomm']['sp_nazione'],$multiple="",$onchange="",$echoId="",$nome="sel_nazione",$where="", $class="textsmall sel-nazioni   select form-control"); ?></div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="ez-last ez-oh spedizione-comune form-inline-el" <?php if($_SESSION['ecomm']['sp_nazione']!="106") echo "style='display:none;'"; ?>>
                      ...
                      <div class="ez-wr">
	                      <div class="sped-prov form-inline-el">
	                         <div class="ez-fl ez-negmr ez-50 spedizione-provincia-label form-inline-el" >
		                      	<div class="ez-box"><?php if($_SESSION['ecomm']['sp_nazione']=="106") echo ln("provincia");?></div>
		                    	</div>
	                        <div class="ez-fl  ez-negmx ez-33 form-inline-el" >
	                          <div class="ez-box"><?php comboBox("province",$field1="sigla",$field2="",$_SESSION['ecomm']['sp_provincia'],$multiple="",$onchange="",$echoId="",$nome="sel_provincia",$where="", $class="textsmall2  select form-control"); ?></div>
	                        </div>
	                       </div>
	                      <div class="sped-comune form-inline-el">
	                        <div class="ez-fl ez-negmr ez-33 form-inline-el sel-comune-label" style="/*width:45px;padding-top:4px;*/">
	                        ...
	                        <div class="ez-last ez-oh form-inline-el">
	                          ...
	                          if($_SESSION['ecomm']['sp_provincia']>0) {
	                            comboBox("comuni",$field1="comune",$field2="",$selected=$_SESSION['ecomm']['sp_comune'],$multiple="",$onchange="",$echoId="",$nome="sel_comune",$where="id_province='".$_SESSION['ecomm']['sp_provincia']."'", $class="textsmall  select form-control");
	                          }else{ ?>
            ...
            <TBODY>  
              <TR>    
                <TD style="vertical-align:bottom;"> 
                  <FORM action="">     
                    <INPUT type=submit value="<?php echo ln("acquista e registrati"); ?>" name="ecomm_registrati" class="submit">
                  </FORM>
                </TD>
                <TD>      
                  <FORM action="">
                    <INPUT type=submit value="<?php echo ln("acquista senza registrarti"); ?>" name="ecomm_acquista"  class="submit">
                  </FORM>
                </TD>    
                <TD>
                  <FORM action="">     
                    <INPUT type=submit value="<?php echo ln("accedi e acquista"); ?>" name="ecomm_accedi" class="submit" >
                  </FORM>
                </TD>
              </TR>
              <TR>    
                <TD style="vertical-align:top;">      
                  <DIV class="ecomm_acquista_reg"><?php echo ln("Per effettuare i tuoi prossimi acquisti in maniera comoda e veloce. Riceverai via mail le credenziali di accesso."); ?> </DIV>
                </TD>    
                <TD style="vertical-align:top;">      
                  <DIV class="ecomm_acquista_no_reg"><?php echo ln("Per un singolo acquisto semplice e rapido."); ?> </DIV>
                </TD>    
                <TD style="vertical-align:top;">      
                  <DIV class="ecomm_acquista_no_reg"><?php echo ln("Se sei gia registrato, inserisci le tue credenziali."); ?> </DIV>
                  <DIV class="ecomm_area_ris">
                    <?php $objHtml->printLoginAreaRis(0); ?>		
                  </DIV>
                </TD>
    ...
    function riepilogoCarrello() {
      ...
      this.setProvincia=function(msg) {
        if(msg==""){
          msg="<select id='sel_comune' name='sel_comune' class='textsmall select form-control'><option value=''></option></select>"
        }
              ...
              g_obj.setImponibile(imponibile,function(){
                g_obj.setIVAeuro(iva,function(){
                  g_obj.setTotale(tot,function(){
                    ...
                    $("#ecomm_riepilogo").css("visibility","visible");
                    $("div.rsLoading").hide();
                    return;
                  });
                });  
      ...
      this.setSpeseSpedizione=function(msg) {
        $("div.rsLoading").show();
        $("#ecomm_riepilogo").css("visibility","hidden");
        g_obj.getDatiGeografici(function(dati){
          dati=dati.split("#_#");
          var g_nazione=dati[0];
          var g_comune=dati[1];
  ...
  function riepilogoDati() { 
    ...
    if(isset($_SESSION["userris_id"])) {
      ...
      $sql="INSERT INTO `".$config_table_prefix."users` (nome,cognome,login,pwd,ragionesociale,indirizzo,cap,citta,provincia,provincia_estera,nazione,comune,regione_estera,partitaiva,codicefiscale,telefono,fax,email,data_di_nascita,cellulare,autorizzo,datecreation) VALUES ( ";
      $sql.="'".($nome)."',";
      $sql.="'".($cognome)."',";
      $sql.="'".($login)."',";
      $sql.="MD5('".$password."'),";
      ...
      if($confirm) {
        $res=1;
        if($objConfig->get("email-from")!="") {
          //$res=$objMailing->mmail($objConfig->get("email-from"),"form@".$_SERVER['SERVER_NAME'],ln("Dati inviati da ".$_SERVER['SERVER_NAME']),replaceEcomerceMarkers($confirm['email_gestore']),$allegato,$allegato_type,$allegato_name);
        }
      }
      ...
      if($ecomm_grp=="17") {
        ...
        /*
        if($err==0) {
          box($messaggio_conferma);
        }else{
          box($messaggio_errore);  
        }
        */
      }
    }
      ...
      <form name="ecomm_riepilogo_dati_form" action='' method='post'>
        ...
        <!--<table><tr><td valign='top' width='18'>&nbsp;</td><td valign='top'>-->
          ...
          <div style="">
            ...
            <? } ?>    				
            <br>
            <div align='center'><input type='image' src='<?php echo $objUtility->getPathBackofficeResources()."proc.png"; ?>' title='<?php echo ln("procedi");?>' /></div>
          </div>
      </form>
    </div>
    <?
  ...
  function addCurrentToCart() {
    ...
    if($_SESSION["userris_id"]>0) $sconto=$articolo['sconto_reg'];
    ...
    $carrello['ecomm_prezzo_senza_sconto']=parseToFloat((($prezzo+$aggiunte)*$area*$q)+$aggiunteF+($aggiunteQ*$q));
    $carrello['ecomm_prezzo_finale']=parseToFloat((($prezzo_scontato+$aggiunte)*$area*$q)+$aggiunteF+($aggiunteQ*$q));
      ...
      if($rs!=false) {
        while (list($key2, $combi) = each($current)) {
          if($key2!=="ecomm_buffer") {
            ...
            $totali['totale']+=($prezzo_scontato*$quantita*$area)+$aggiunteF-$sconto_aggiunteF+($aggiunteQ*$quantita)-($sconto_aggiunteQ*$quantita);
            $totali['totale_imponibile']+=$this->verIVA(($prezzo_scontato*$quantita*$area)+$aggiunteF-$sconto_aggiunteF+($aggiunteQ*$quantita)-($sconto_aggiunteQ*$quantita),$iva);
            $totali['somma_prezzi']+=$prezzo*$quantita*$area;
            $totali['iva']+=($this->verIVA(($prezzo_scontato*$quantita*$area)+$aggiunteF-$sconto_aggiunteF+($aggiunteQ*$quantita)-($sconto_aggiunteQ*$quantita),$iva)*$iva)/100;
            $totali['sconto']+=($sconto_calc*$quantita*$area)+$sconto_aggiunteF+($sconto_aggiunteQ*$quantita);
            $totali['aggiunte']+=($aggiunte*$quantita*$area)+$aggiunteF-$sconto_aggiunteF+($aggiunteQ*$quantita)-($sconto_aggiunteQ*$quantita);
  ...
  function updatePrezzi() {
    ...
    $prezzo_scontato=(($prezzo+$aggiunte)*$q*$area)+$aggiunteF+($aggiunteQ*$q);
    ...
    $carrello['ecomm_aggiunte_f']=parseToFloat($aggiunteF);
    $carrello['ecomm_aggiunte_q']=parseToFloat($aggiunteQ);
    $carrello['ecomm_prezzo_senza_sconto']=parseToFloat((($prezzo+$aggiunte)*$q*$area)+$aggiunteF+($aggiunteQ*$q));
    ...
    while (list($key, $row) = each($tariffa)) {
      ...
      if( ($sp_peso[0]['da']>0 || $sp_peso[0]['a']>0) && ($sp_peso[0]['ingombro_da']>0 || $sp_peso[0]['ingombro_a']>0) ) {
        if($sp_peso[0]['da']<=$peso && $sp_peso[0]['a']>=$peso && $sp_peso[0]['ingombro_da']<=$ingombro && $sp_peso[0]['ingombro_a']>=$ingombro) {
          array_push($tar, $row['tariffa_cry']);  
        }
      }
  ...
  function UpdateOrder($esito) {
    ...
    //$sql="UPDATE ".$config_table_prefix."ecommerce_ordini SET riepilogo_editor='".$esito."-".$itemname."-".$idordine."-".$itemnum."' WHERE id='118'";
    //mysql_query($sql);
  ...
  function action() {  
    ...
    if(isset($_GET['keyclient_cancel_return'])) {
      ...
      $objHtml->adminPageRedirect("index.php","");
      exit;   
    }
    ...
    if(isset($_REQUEST['codTrans']) && isset($_REQUEST['esito'])) {
      ...
      if($ordine['pagamenti_riusciti']==1) {
        ...
        $objHtml->adminPageRedirect("index.php",ln($mess_conferma));  
      } else {
        $mess_conferma=$this->UpdateOrder(-1);
        $objHtml->adminPageRedirect("index.php",ln($mess_conferma));
      }
    ...
    if(isset($_GET['paypal_return']) || isset($_GET['paypal_cancel_return']) ) {
      ...
      if(isset($_GET['paypal_cancel_return'])) {
        $sql="UPDATE ".$config_table_prefix."ecommerce_ordini SET id_ecommerce_stati='10' WHERE id='".$_GET['paypal_cancel_return']."'";
        mysql_query($sql);
        $objHtml->adminPageRedirect("index.php","");
      }
      ...
      while($i<30){
        ...
        $ecommerce_paypal=getTable("ecommerce_paypal","","id_ordini='".$_GET['paypal_return']."'");
        if(count($ecommerce_paypal)>0) {
          if($ecommerce_paypal[0]["pagamenti_riusciti"]==1){
            $this->emptyCart();
            $mess_conferma=getTable("ecommerce_testi","","(nome='messaggio conferma ordine' AND attivo='1')");
            $str=ln($mess_conferma[0]['testo_editor']);
            break;
          }elseif($ecommerce_paypal[0]["pagamenti_riusciti"]==-1){
            $mess_conferma=getTable("ecommerce_testi","","(nome='messaggio errore pagamento' AND attivo='1')");
            $str=ln($mess_conferma[0]['testo_editor']);
            break;
          } 
      ...
      $objHtml->adminPageRedirect("index.php",$str);
      exit;
    } 
    ...
    if(isset($_POST['ecomm_sp_comune']) || isset($_POST['ecomm_sp_nazione'])){
      ...
      if($_POST['ecomm_sp_nazione']!=106 && ($_POST['ecomm_sp_regione_estera']=="-1" || $_POST['ecomm_sp_regione_estera']=="-2")) { ?>
        <div class="ez-last ez-oh spedizione-regione-estera form-inline-el">
          <div class="ez-box"><?php comboBox("regioni_estere",$field1="regione_en",$field2="",$selected=$_SESSION['ecomm']['sp_regione_estera'],$multiple="",$onchange="",$echoId="",$nome="sel_regione_estera",$where="id_nazioni='".$_POST['ecomm_sp_nazione']."'", $class="textsmall select form-control sel-regione-estera form-inline-el"); ?></div>
        </div>
      <? exit;} ?>
    ...
    if(isset($_POST['ecomm_sp_provincia'])){
      if($_POST['ecomm_sp_provincia']>0){
        ...
        comboBox("comuni",$field1="comune",$field2="",$selected=$_SESSION['ecomm']['sp_comune'],$multiple="",$onchange="",$echoId="",$nome="sel_comune",$where="id_province='".$_POST['ecomm_sp_provincia']."'", $class="textsmall select  form-control");
      }
      exit;
    }
    ...
    if(isset($_POST['myRsCarrello'])) {
      ...
      if($_POST['myRsCarrello']=="setCaratteristiche") {
        ...
        echo currencyITA(($aggiunta*$tmpQ*$this->getQuantita())+$aggiuntaf+($aggiuntaq*$this->getQuantita()))."#AA134#".$gallery."#AA134#"."<div class='fumetto'>".$tmpfumetto."</div>"."#AA134#".rawurlencode(serialize($abbinamenti))."#AA134#".$tmpaggiunta['richiedi_quotazione'];
      ...
      if($_POST['ecomm_pagamenti_do']==1 && isset($_POST['ecomm_pagamento'])) {
        ...
        for($zy=0;$zy<2;$zy++) { 
          ...
          if(isset($_POST['altra'])) {
            ...
            if(strtolower($_POST['altra_nazione'] && $_POST['altra_comune']!="")=="italy") $mess.="<table><tr><td width='140'>".ln("comune",$zy)."</td><td> <b>".$_POST['altra_comune']."</b></td></tr></table>";
              ...
              */
              ...
              while (list($key2, $variante) = each($prodotto)) { 
                if($key2!=="ecomm_buffer") {
                  ...
                  //$mess.="<div style='font-size:14px;font-weight:bold;margin-top:20px;'>".ln($nome_prodotto,$zy)."</div><br>";
                  ...
                  //$mess.="<table><tr><td width='140'>".ln("Prezzo unitario",$zy)."</td> <td><b>&euro; ".currencyITA($prezzo)."</b></td></tr></table>";
                  //if(($aggiunte!="" && $aggiunte!=0)||($aggiunteF!="" && $aggiunteF!=0)) $mess.="<table><tr><td width='140'>".ln("Personalizzazioni",$zy)."</td> <td><b>&euro; ".currencyITA(($aggiunte*$quantita)+$aggiunteF)."</b></td></tr></table>";
                  //if($sconto>0) $mess.="<table><tr><td width='140'>".ln("Sconto",$zy)."</td> <td><b>&euro; ".currencyITA((($prezzo*$sconto)/100))." (".round($sconto,2)."%)"."</b></td></tr></table>";
                  //$mess.=ln("IVA",$zy).": <b>&euro; ".currencyITA($iva/$quantita)." ($iva_perc%)</b><br>";
                  $mess.="<table><tr><td width='140'>".ln("Totale articolo",$zy)."</td> <td><b>&euro; ".currencyITA(($prezzo_scontato*$quantita*$area)+$aggiunteF-$sconto_aggiunteF+($aggiunteQ*$quantita)-($sconto_aggiunteQ*$quantita))."</b></td></tr></table>";
                  $mess.="</td></tr></table>";
                  //$mess.=ln("Totale IVA",$zy).": <b>&euro; ".currencyITA($iva)."</b><br>";
                  //$mess.=ln("Totale",$zy).": <b>&euro; ".currencyITA($prezzo_finale+$iva)."</b><br>";
                  //$mess.=ln("Peso",$zy).": <b>".currencyITA(($peso/1000)*$quantita)." kg</b><br>";
                  ...
                  $sql.="'".parseToFloat(($prezzo*$quantita*$area)+$aggiunteF+($aggiunteQ*$quantita))."','";
                  $sql.="'".parseToFloat(($aggiunte*$quantita*$area)+$aggiunteF+($aggiunteQ*$quantita))."',";
                  $sql.="'".$sconto."',";
                  $sql.="'".parseToFloat((($prezzo_scontato+$aggiunte)*$quantita*$area)+$aggiunteF+($aggiunteQ*$quantita))."')";
          ...
          if($_SESSION['ecomm']['ritiro_in_sede']!=1) {
            $ritiro_in_sede=0;
            //$mess.=ln("Spese di spedizione",$zy).": &euro; ".currencyITA($spese_spedizione);
            $tmpnazione=retRow("nazioni",$_SESSION["ecomm"]["sp_nazione"]);
            $tmpcomune=retRow("comuni",$_SESSION["ecomm"]["sp_comune"]);
            $tmpregione=retRow("regioni_estere",$_SESSION["ecomm"]["sp_regione_estera"]);
            //$mess.=ln(" calcolate per ",$zy).": ".$tmpnazione['nazione'];
            //if($_SESSION["ecomm"]["sp_comune"]!="") $mess.=", ".$tmpcomune["comune"];
            //if($_SESSION["ecomm"]["sp_regione_estera"]!="") $mess.=", ".$tmpregione["regione"];
            $mess.="<br><br>"; 
          } else {
            $ritiro_in_sede=1;
            //$mess.=ln("Spese di spedizione",$zy).": <b>".ln("RITIRO IN SEDE",$zy)."</b><br><br>";
          }
          ...
          $tot_iva=0;
          if($_SESSION["ecomm"]["sp_nazione"]=="106"){
          ...
          if(ParseToFloat($spese_spedizione)>0) {
            $mess.="<table><tr><td width='140'>".ln("Spese di spedizione",$zy)." (";
          ...
          /*
          $mess.="<table><tr></tr></table>";
          $mess.="<table><tr></tr></table>";
          $mess.="<table><tr><td width='140'>".ln("Totale",$zy)."</td> <td><b>&euro; ".currencyITA(ParseToFloat($imponibile)+ParseToFloat($ivaeuro))."</b></td></tr></table>";
          */
          //$mess.=ln("Peso complessivo",$zy).": <b>".currencyITA($totPeso/1000)." kg</b><br>"; 
          
          //}
          
          //$pagamento['descrizione_editor']=str_replace("&rsquo;", "'", $pagamento['descrizione_editor']);
          //if($zy==0) $mess.=ln($pagamento['descrizione_editor'],$zy)."<br>";
          $mess.="<br><br>";
          ...
          $sql="INSERT INTO ".$config_table_prefix."ecommerce_ordini (user_hidden,altra_destinazione_hidden,spedizione_hidden,documents_hidden,codice_vendita,riepilogo_editor,data,ora,id_ecommerce_stati,totale_cry) VALUES (";
          $sql.="'".$user['id']."',";
          $sql.="'".$idaltra_dest."',";
          $sql.="'".$idspedizione."',";
          $sql.="'".$iddocs."',";
          ...
          if($zy==1) {
            $mess=str_replace("#INFO-DATI-PAGAMENTO#", "", $mess);
            
            $idpdf=genPDFbyHTML(utf8_decode($mess),0,ln("Ordine N. ",$zy).$idordine.ln(" DEL ",$zy).dataIta().".pdf");
            $sql="UPDATE ".$config_table_prefix."ecommerce_ordini SET pdf_file='$idpdf' WHERE id='$idordine'";
            mysql_query($sql);
  ...
  function valPayPalCode($code) {
    ...
    if(count($rs)>0) {
      ...
      $sql="INSERT INTO ".$config_table_prefix."ecommerce_paypal (id_ordini,code) VALUES ('".$idordini."','".$code."')";
      mysql_query($sql);
      return false;  
    }
  }
  ...
  function CarrelloAjax() {
    ...
    function ecomm_initCartAjax() {
      if(rsCAjax=="") {
        rsCAjax=1;
        var tmpCart=new CarrelloAjax('<?php echo $this->getCurrent(); ?>','<?php echo $this->getCombi(); ?>',"<?php echo ln('Prodotto aggiunto al carrello'); ?>.<br><a href='<?php echo $_SESSION['ecomm']['viewcart']['url_vai_cassa']; ?>?menid=<?php echo $_SESSION['ecomm']['viewcart']['menid']; ?>&ecomm_riepilogo=1'><?php echo ln('Vai al carrello'); ?></a> <?php echo ln('oppure'); ?> <a class='crt-result-close-a' href='#'><?php echo ln('Continua lo shopping'); ?></a>","<?php echo ln('Modifiche salvate correttamente.'); ?><br><a href='<?php echo $_SESSION['ecomm']['viewcart']['url_vai_cassa']; ?>?menid=<?php echo $_SESSION['ecomm']['viewcart']['menid']; ?>&ecomm_riepilogo=1'><?php echo ln('Vai al carrello'); ?></a> <?php echo ln('oppure'); ?> <a class='crt-result-close-a' href='#'><?php echo ln('continua lo shopping'); ?></a>","<?php echo $info_carello[0]['prodotti_consigliati']; ?>");
        tmpCart.initAjax();
      }  
    }
  ...
  function stampaCarrello() {
    ...
    if($ecommerce_generali[0]['Descr1']!="") $articolo_testi[0]['testo_editor']=$ecommerce_generali[0]['Descr1']; 
                      ...
                      <div class="ez-fl  ez-negmx ez-33 crt-caratteristiche-input bts-caratteristiche-input" style="width:80%">
                        <div class="ez-box" >
                          ...
                          if($tipo=="7" && count($ecommerce_valori)>0) { 
                            ...
                            <div class="row" caratteristica="<?=$tmp_caratteristiche['id']?>" name="<?=$idnome?>">
                              <?php
                              while (list($key2, $tmp_valori) = each($ecommerce_valori)) { 
                                $f="immagine_file";
                                $f2="immagine2_file";
                                ...
                                <div class="col-md-5ths col-xs-6">
                                  <?php if(retFile($tmp_valori[$f])) { ?>
                                    <div  src="<?php echo retFile($tmp_valori[$f],$this->g_smallImgW); ?>" <?php if(retFile($tmp_valori[$f],$this->g_zoomImgW)) { ?>zoom="<?php echo retFile($tmp_valori[$f],$this->g_zoomImgW); ?>" <? } ?> value="<?=$tmp_valori['id'];?>" class="thumbnail crt-caratteristiche-aff <?php if(in_array($tmp_valori['id'],$combi_val[$combid])) echo "crt-caratteristiche-aff-sel"; ?>" crtDescr="<?php echo htmlentities($tmp_valori['fumetto_editor']); ?>" caratteristica="<?=$tmp_caratteristiche['id']?>" name="<?=$idnome?>" crtTitle="<?php echo htmlentities($tmp_valori['nome']); ?>" >
                                      <a href="<?=retFile($tmp_valori[$f],$this->g_zoomImgW)?>" class="crt-fotogallery-thm <?php if($notZoom==false) { ?>cloud-zoom-gallery<? } ?>" title="" rel="useZoom: 'crt-foto-articolo-zoom', smallImage: '<?=retFile($tmp_valori[$f],$this->g_smallImgW)?>'">
                                        <img src="<?php echo retFile($tmp_valori[$f],$this->g_smallImgW); ?>" alt="<?php echo $tmp_valori['nome']; ?>" style="width:100%">
                                        <div class="caption">
                                          <p style="text-align:center;"><?php echo $tmp_valori['nome']; ?></p>
                                        </div>
                                      </a>
                                    </div>
                                  <? } ?>
                          ...
                          if($tipo=="11") { 
                            ...
                            <div class="ez-wr form-inline">
                              <div class="ez-fl ez-negmr ez-50 form-group">
                                <label for="<?=$idnome?>_1"><?php echo ln("Base"); ?></label><br><input class="text crt-upd-dim1 form-control" name="<?=$idnome?>_1" type="text" id="" value="<?=$dimV[0]?>" />
                              </div>
                              <div class="ez-last ez-oh  form-group">
                                <label for="<?=$idnome?>_2"><?php echo ln("Altezza"); ?></label><br><input class="text crt-upd-dim2 form-control" name="<?=$idnome?>_2" type="text" id="" value="<?=$dimV[1]?>" />
                              </div>
                            </div>
