...
;(function($) {
  ...
  $.buildOfficeBar = function(object, options) {
    ...
    $("div.list>ul, div.off_textlist>ul", object).each(function() {
    ...
    //text button lists
    $("div.off_textlist li>a", object).each(function() {
      $(this).wrapInner('<span></span>');
    });

    //dropdown lists
    $("li.off_dropdown ul>li", object).each(function() {
      $(this).wrapInner('<span></span>');
    });
    ...
    $("div.off_textlist li.off_dropdown div", object).each(function(){
      var me = $(this);
      me.prev() //TODO: check node type
        .data("officebar.menu",
           me.clone()
    ...
    $("div.off_textlist li.off_dropdown>a", object).bind("click", function(e) {
      var me = $(this);
      var menu = me.data("officebar.menu");
      if(menu) {
        if(menu.is(":visible")) {
