...
function sortTable(td_element,ignoreLastLines) {
  ...
  var sortImages =[getPathBackofficeResources+'desc.gif',getPathBackofficeResources+'asc.gif',getPathBackofficeResources+'none.gif',getPathBackofficeResources+'sorting.gif'];
  ...
  if (sortAscending) { 
    var sortColtmp = new Array();
    sortColtmp.push(sortCol[0]);
    sortCol.reverse();

    for (var k=0; k<sortCol.length-1; k++) {
      sortColtmp.push(sortCol[k]);
    }
    sortCol=sortColtmp;
  }
