...
(function($)
{
		...
		return this.each(function() {
			...
			*/
			if(options.autoResize == true) {
				var rs_windows = obj.parents("div.rs-windows");
        // if true resize the table when the browser resizes
				rs_windows.resize( function() {
    ...
    var hasTable = obj.find("table").size() > 0; // returns true if there is a table
		...
		if(hasTable && hasTHead && hasTBody) {
		  ...
		  var tableHeight = parentDivHeight;
			...
			obj.find('div.fht_table_body').css({'width':(parentDivWidth+2) + 'px', 'height':(tableBodyHeight+7) + 'px'});
			table.css('width','100%');
