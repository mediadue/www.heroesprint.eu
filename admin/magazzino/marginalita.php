		...
		<div id="area">
            ...
            <form action="action.php" id="frm1" name="frm1" method="post" enctype="multipart/form-data" />
              <div class="elemento">
                ...
                $column="data";
                ?>
                <div class="label">Marginalità per marchio:<label for="<? echo $label; ?>"> </label></div>
        				<div class="value">                                                   
                  ...
                  &nbsp;&nbsp;<input type="submit" name="act_MARGINALITA-MARCHIO" value="calcola" class="btn" />
                </div>
                
                <div class="label">Marginalità per categoria:<label for="<? echo $label; ?>"> </label></div>
                <div class="value" style="border:0px red solid;padding-left:160px;">
                  ...
                  &nbsp;&nbsp;<input type="submit" name="act_MARGINALITA-CATEGORIA" value="CALCOLA" class="btn" />
                </div>
